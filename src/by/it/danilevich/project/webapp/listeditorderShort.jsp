                ...
                <div class="row">
                    <form class="form-inline order-${order.id}" action="do?command=EditOrder" method=POST>
                        ...
                        <div class="form-group mb-1">
                            <input id="dataString" class="form-control input-md" type="disabled" name="dataString" value="${order.dateString}" title=""/>
                        </div>
                     ...
                     <div class="form-group mb-1">
                        ...
                        <div class="form-group mb-1">
                         ...
                         <input id="data" class="form-control input-md" name="data" type="hidden" value="${order.dateOrder}" title=""/>
