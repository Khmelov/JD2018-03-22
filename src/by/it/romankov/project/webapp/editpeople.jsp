        ...
        <div class="row">
            <form class="form-inline people-${people.id}" action="do?command=EditPeople" method=POST>
                ...
                <div class="form-group mb-1">
                    <input id="login" class="form-control input-md" name="name"
                ...
                <div class="form-group mb-1">
                                    <input id="password" class="form-control input-md" name="login"
                                           value="${people.login}" title=""/>
                 </div>
                  <div class="form-group mb-1">
                                      <input id="password" class="form-control input-md" name="age"
                                             value="${people.age}" title=""/>
                                  </div>
                   <div class="form-group mb-1">
                                       <input id="password" class="form-control input-md" name="telephone"
