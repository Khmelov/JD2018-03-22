package by.it.fando.jd03_03.dao;

import by.it.fando.jd03_03.dao.daobeans.AdDAO;
import by.it.fando.jd03_03.dao.daobeans.RoleDAO;
import by.it.fando.jd03_03.dao.daobeans.UserDAO;
...
public class DAO {
    ...
    public void reset(){
        ...
        try (Connection connection =
            ...
            statement.executeUpdate("INSERT INTO `fando`.`users` (`id`, `login`, `email`, `password`, `roles_id`) VALUES (DEFAULT, 'adminitrator', 'adm@mail.ru', 'administrator', 1)");
            statement.executeUpdate("INSERT INTO `fando`.`users` (`id`, `login`, `email`, `password`, `roles_id`) VALUES (DEFAULT, 'user', 'user@mail.ru', 'user', 2)");
            statement.executeUpdate("INSERT INTO `fando`.`ads` (`id`, `description`, `rooms`, `price`, `area`, `flat`, `flats`, `address`, `users_id`) VALUES (DEFAULT, 'good flat', 1, 111111, 111, 1, 1, 'minsk 1', 2)");
