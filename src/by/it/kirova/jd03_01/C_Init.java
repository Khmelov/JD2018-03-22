    ...
    public static void main(String[] args) {
        ...
        try (Connection connection =
            ...
            statement.executeUpdate("CREATE TABLE IF NOT EXISTS `kirova`.`role_has_users` (\n" +
                    ...
                    "    ON UPDATE RESTRICT)\n" +
                    "ENGINE = InnoDB;");
            statement.executeUpdate("INSERT INTO `kirova`.`users` (`user_id`, `email`, `password`, `first_name`, `last_name`, `middle_name`, `residence_country`, `phone_number`) VALUES (DEFAULT, 'abc@gmail.com', 'abc123', 'John', 'Smith', NULL, 'UK', '+447874564567');");
            statement.executeUpdate("INSERT INTO `kirova`.`users` (`user_id`, `email`, `password`, `first_name`, `last_name`, `middle_name`, `residence_country`, `phone_number`) VALUES (DEFAULT, 'def@gmail.com', 'def123', 'Jacob', 'Irwin', NULL, 'Poland', '+485291111111');");
            statement.executeUpdate("INSERT INTO `kirova`.`users` (`user_id`, `email`, `password`, `first_name`, `last_name`, `middle_name`, `residence_country`, `phone_number`) VALUES (DEFAULT, 'hij@gmail.com', 'hij123', 'Aleksandr', 'Aleksandrov', 'Aleksandrovich', 'Belarus', '+375291111111');");
            ...
            statement.executeUpdate("INSERT INTO `kirova`.`role_has_users` (`role_role_id`, `users_user_id`) VALUES (2, 3);");
