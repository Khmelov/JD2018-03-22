...
public class Book {
    ...
    public Book(int bookid, int categoryid, long bookdateadded, String bookname, String booklang,
    ...
    public long getBookdateadded() {
        return bookdateadded;
    }

    public void setBookdateadded(long bookdateadded) {
        this.bookdateadded = bookdateadded;
    }
