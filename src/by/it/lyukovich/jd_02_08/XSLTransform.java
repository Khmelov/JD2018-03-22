...
public class XSLTransform {
    ...
    private final static String root="src/by/it/lyukovich/jd_02_07/";
    public static void main(String[ ] args) {
        String fileName=root+"Books.xml";
        String fileHTML=root+"Books.html";
        String transform="src/by/it/lyukovich/jd_02_08/transform.xsl";
        try {
