...
public class TaskA_AddUser {
    public static void main(String[] args) {
        ...
        try (Connection connection = DriverManager.getConnection(
            ...
            statement.executeUpdate("INSERT INTO `verishko`.`users` (`id`, `login`, `email`, `password`, `roles_id`) VALUES (DEFAULT, 'user2', 'user2@mail.ru', 'user2', 2)");
            statement.executeUpdate("INSERT INTO `verishko`.`users` (`id`, `login`, `email`, `password`, `roles_id`) VALUES (DEFAULT, 'user3', 'user3@mail.ru', 'user3', 2)");
            statement.executeUpdate("INSERT INTO `verishko`.`users` (`id`, `login`, `email`, `password`, `roles_id`) VALUES (DEFAULT, 'guest', 'guest3@mail.ru', 'user3', 3)");
            connection.close();
